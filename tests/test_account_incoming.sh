...
./tests/assert_result.sh "insert into OPENBILL_INVOICES  (id, number, destination_account_id, title, amount_cents) values ($INVOICE_UUID, 'first', $ACCOUNT1_UUID, 'test', 10000)" 'INSERT 0 1' && \
