...
./tests/assert_result_include.sh "insert into OPENBILL_TRANSACTIONS (amount_cents, amount_currency, from_account_id, to_account_id, key, details) values (100, 'USA', $ACCOUNT1_UUID, $ACCOUNT2_UUID, 'gid://order1', 'test');" "Account (from #$_ACCOUNT1_UUID) has wrong currency" && \
